package org.hpdroid.base.view.album.ucrop.view.widget;
...
public class HorizontalProgressWheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mProgressLinePaint.setColor(getResources().getColor(R.color.line_light));
    ...
    private void init() {
        mMiddleLineColor = ContextCompat.getColor(getContext(), R.color.line_light);
